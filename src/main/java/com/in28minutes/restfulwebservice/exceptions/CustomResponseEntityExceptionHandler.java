...
/**
 * @author Sameer Created on Feb 3, 2021 5:28:07 PM
 */
...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<CustomException> handleAllExceptions(Exception ex, WebRequest request) {
	...
	public ResponseEntity<CustomException> handleUserNotFoundException(UserNotFoundException ex, WebRequest request) {
		CustomException customException = new CustomException(new Date(), ex.getMessage(),
				request.getDescription(false));
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		CustomException customException = new CustomException(new Date(), "Validation Failed",
